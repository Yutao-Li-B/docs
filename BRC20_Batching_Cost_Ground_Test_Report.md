...
On the **free plan**, we have **60,000 API calls per month** (5 calls/second rate limit).

### Scaling

If we scale this solution, we will need to purchase UniSat API calls. See [UniSat Developer Plans](https://developer.unisat.io/plan).

| Plan | Cost | Calls/Month | Rate Limit |
|------|------|-------------|------------|
| **Free** | $0 | 60,000 | 5 calls/sec |
| **Specialist** | $90/mo ($72/mo yearly) | 300,000 | 5 calls/sec |
| **Enterprise** | $600/mo ($480/mo yearly) | 3,000,000 | 10 calls/sec |
| **Pay-as-you-go** | $0.40/1,000 calls | Flexible | - |
